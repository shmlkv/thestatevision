    ...
    <section className="py-12 md:py-16 lg:py-20">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 items-center">
        <div className="lg:col-span-2 space-y-4">
          <h2
            className={`${fontGloock.className} text-6xl font-bold tracking-tighter sm:text-4xl md:text-5xl`}
          >
            {data.title}
          </h2>
          <p className={`text-muted-foreground max-w-[600px] text-3xl`}>
            {/* {data.description} */}
            traditional governance is a joke
            <br />
